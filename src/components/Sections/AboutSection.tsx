    ...
    >
      ...
      <p className="leading-relaxed mb-4 text-sm sm:text-base text-[#555] dark:text-neutral-300">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="font-semibold text-black dark:text-white hover:text-red-600 hover:dark:text-red-600 transition duration-300 border-b border-b-black dark:border-b-white hover:border-b-red-500"
        >
          MKBHD
        </a>
        ,{" "}
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="font-semibold text-black dark:text-white hover:text-orange-600 hover:dark:text-orange-600 transition duration-300 border-b border-b-black dark:border-b-white hover:border-b-orange-600"
        >
          LTT
        </a>
